...
#define DECLARE_DELEGATE(Name)                                  using Name = Delegate<void>

// Declare delegate of type - ReturnType().
#define DECLARE_DELEGATE_Return(Name, ReturnType)               using Name = Delegate<ReturnType>

// Declare delegate of type - void(params...)
#define DECLARE_DELEGATE_Params(Name, ...)                      using Name = Delegate<void, __VA_ARGS__>

// Declare delegate of type - ReturnType(params...).
#define DECLARE_DELEGATE_Return_Params(Name, ReturnType, ...)   using Name = Delegate<ReturnType, __VA_ARGS__>

// Declare multicast delegate of type - void().
#define DECLARE_DELEGATE_MULTICAST(Name)                        using Name = DelegateMulticast<>

// Declare multicast delegate of type - void(params...).
#define DECLARE_DELEGATE_MULTICAST_Params(Name, ...)            using Name = DelegateMulticast<__VA_ARGS__>
...
{
    ASSERT(mBindingsNum < s_MaxBindings);
